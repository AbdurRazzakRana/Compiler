...
{
      22,     0,    -1,    23,    26,    -1,    23,    25,    -1,    23,
      24,    -1,    -1,     7,     4,    16,    17,    -1,     6,     4,
      16,    17,    -1,    -1,    26,    27,    17,    -1,    26,     1,
      17,    -1,    28,    -1,     4,    18,    28,    -1,    19,    28,
      20,    -1,    28,    11,    28,    -1,    28,    10,    28,    -1,
      28,    12,    28,    -1,    28,    13,    28,    -1,    28,    14,
      28,    -1,    28,     9,    28,    -1,    28,     8,    28,    -1,
      11,    28,    -1,     4,    -1,     3,    -1,     5,    -1
};
...
{
       0,   127,   127,   129,   130,   131,   134,   171,   210,   211,
     212,   216,   218,   246,   248,   250,   252,   257,   259,   261,
     263,   267,   269,   294,   299
};
#endif
...
{
  "$end", "error", "$undefined", "INTEGER", "VARIABLE", "FLOAT", "T_INT",
  "T_FLOAT", "'|'", "'&'", "'+'", "'-'", "'*'", "'/'", "'%'", "UMINUS",
  "';'", "'\\n'", "'='", "'('", "')'", "$accept", "P", "DECLS",
  "DECL_FLOAT", "DECL_INT", "list", "stat", "expr", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
      ...
      43,    45,    42,    47,    37,   263,    59,    10,    61,    40,
      41
};
# endif
...
{
       5,     0,     8,     1,     0,     0,     4,     3,     0,     0,
       0,     0,    23,    22,    24,     0,     0,     0,    11,     0,
       0,    10,     0,    22,    21,     0,     9,     0,     0,     0,
       0,     0,     0,     0,     7,     6,    12,    13,    20,    19,
      15,    14,    16,    17,    18
};
...
{
     -11,     2,     6,   -11,     3,    10,   -11,   -11,     0,   -10,
      -6,    27,   -11,    29,   -11,    24,    24,    45,    41,    46,
      48,   -11,    24,   -11,   -11,    28,   -11,    24,    24,    24,
      24,    24,    24,    24,   -11,   -11,    41,   -11,    47,    20,
       4,     4,   -11,   -11,   -11
};
...
{
      -2,    11,     3,    12,    13,    14,    19,     9,    24,    25,
      20,    15,     4,     5,    10,    36,    31,    32,    33,    16,
      38,    39,    40,    41,    42,    43,    44,    12,    23,    14,
      29,    30,    31,    32,    33,    15,    27,    28,    29,    30,
      31,    32,    33,    16,    21,     0,     0,    22,    37,    27,
...
{
       0,     1,     0,     3,     4,     5,    16,     4,    15,    16,
      16,    11,     6,     7,     4,    22,    12,    13,    14,    19,
      27,    28,    29,    30,    31,    32,    33,     3,     4,     5,
      10,    11,    12,    13,    14,    11,     8,     9,    10,    11,
      12,    13,    14,    19,    17,    -1,    -1,    18,    20,     8,
...
{
       0,    22,    23,     0,     6,     7,    24,    25,    26,     4,
       4,     1,     3,     4,     5,    11,    19,    27,    28,    16,
      16,    17,    18,     4,    28,    28,    17,     8,     9,    10,
      11,    12,    13,    14,    17,    17,    28,    20,    28,    28,
      28,    28,    28,    28,    28
};
...
#line 135 "lab4.y"
    {
		...
		if ((yyvsp[(2) - (4)].string) == NULL){
			...
			struct SymbTab * is_var_on_symtable = Search((yyvsp[(2) - (4)].string));
			if(is_var_on_symtable != NULL){
				...
				if (regs_counter >= LIMIT){
					...
					Insert((yyvsp[(2) - (4)].string), regs_counter);
...
#line 219 "lab4.y"
    {
				...
				if ((yyvsp[(1) - (3)].string) == NULL){
					...
					if (Search((yyvsp[(1) - (3)].string)) == NULL){
						...
						int var_addr = FeatchAddress((yyvsp[(1) - (3)].string));

						// setting the value of $3 to that address register
						regs[var_addr] = (yyvsp[(3) - (3)].value); 
					}
				}
			}
    break;
...
#line 270 "lab4.y"
    {
				...
				if (Search((yyvsp[(1) - (1)].string)) == NULL){
					...
					int addr = FeatchAddress((yyvsp[(1) - (1)].string));
					
					// Setting the answer from the register of that address
					(yyval.value) = regs[addr];
				}
...
#line 299 "lab4.y"
    {
		(yyval.value)=(float) (yyvsp[(1) - (1)].myfloat);
		// printf("FLOAT: %f\n", $$);
		if(mydebug)
				fprintf(stderr,"found an integer\n");
	}
