...
_L4:		#While Loop START
	...
	beq $a0 $0 _L6		# IF branch decision, taken to else condidion or continue to if body
	j _L5		# Break the loop and jump to Loop End
	j _L7		# As else is not taken, jump to loop end
_L6:		#Else target level if the branch is taken
_L7:		# End of If Scope
	move $a0 $sp		# VAR local make a copy of stackpointer
	addi $a0 $a0 8		# VAR local stack pointer plus offset
	lw $a0, ($a0)		# Expression is a VAR
